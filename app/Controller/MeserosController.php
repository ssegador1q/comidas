	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Mesero->save($this->request->data)) {
				$this->Session->setFlash('El mesero a  sido creado.','default',array('class'=>'alert alert-success'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('El mesero no a sido creado.','default',array('class'=>'alert alert-danger'));
			}
		}
	}
