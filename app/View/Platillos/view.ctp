<?php echo $this->Html->script( array('addtocart.js'), array('inline' => false) ); ?>	
	<!-- llamamos  al archivo addtocard directamente desde  la vista-->
...
<div class="row">
	...
	<div class="col col-sm-5">
		...
		<?php echo $this->Form->button('Agregar a Pedido', array('class' => 'btn btn-primary addtocart', 'id' => $platillo['Platillo']['id']) ); ?> <!--se  debe  crear  un query  para q  el boton cunfione,se  crea  un javascript en  js addtocard -->
